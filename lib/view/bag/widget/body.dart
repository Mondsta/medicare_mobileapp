    ...
    return Container(
      ...
      child: FadeAnimation(
        ...
        child: Row(
          ...
          children: [
            const Text("Keranjang", style: AppThemes.bagTitle),
            Text(
              "Total ${lengthsOfItemsOnBag} Barang",
        ...
        children: [
          FadeAnimation(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("TOTAL HARGA", style: AppThemes.bagTotalPrice),
                Text("\IDR ${AppMethods.sumOfItemsOnBag()}",
