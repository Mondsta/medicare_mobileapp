...
import 'package:medicare_application/animation/fadeanimation.dart';
        ...
        child: Column(
          ...
          children: [
            FadeAnimation(
              delay: 0.5,
              child:
                  Text("Keranjang Kosong", style: AppThemes.bagEmptyListTitle),
            ),
            FadeAnimation(
              delay: 0.5,
              child: Text(
                "Tambahkan Produk Ke Keranjang Kamu Dulu",
